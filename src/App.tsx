...
// 主应用内容组件 - 包裹在 ToastProvider 内以使用 useToast
function AppContent() {
    ...
    <>
      <SubscriptionProvider>
        <Routes>
          ...
          {/* 404 */}
          <Route path="*" element={<div className="min-h-screen flex items-center justify-center bg-slate-50"><div className="text-center"><h1 className="text-4xl font-bold text-slate-900">404</h1><p className="text-slate-400 mt-2">页面不存在</p></div></div>} />
        </Routes>
      </SubscriptionProvider>
